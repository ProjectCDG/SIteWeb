...
<div class="form-group row">
    <label for="password2" class="col-sm-4 col-form-label">Confirmer le mot de passe:</label>
    <div class="col-sm-8">
...
<div class="form-group row">
    <div class="col-sm-12">
	<input id="submit" class="btn btn-primary" type="submit" name="submit" value="Valider">
    </div>
	</div>
	</form>
</div>
